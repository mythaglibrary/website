---
title: Changelog
description: A summary of the changes made to Cheri's Morimens New Player Handbook over time.
...
| Date | Notes |
| --: | :-- |
| **8 Sep 2026** | Added GRamona and Jenkin as C tier DPS (endgame). Moved Mouchette and GLotan up to B tier DPS (endgame). Edited Spending Your Resources to clarify that some standard units are no longer viable in "endgame" since endgame has changed. Mentioned in How to Build a Team that poison is bad in Madness difficulty. Made a few other wording edits. |
...
For older changes, see the [original Google Docs version of this guide](https://docs.google.com/document/d/1THjxR9hHs4NWHqSWHHa2dHAGuE_cRGelfzXdBfCnIlM/edit?tab=t.irprt5fvrfa9).