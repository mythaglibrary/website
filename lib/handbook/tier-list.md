...
A yellow bar <span style="color: var(--md-tier-free);">■</span> means it’s a free character you can get without using pulls.

A blue bar <span style="color: var(--md-tier-standard);">■</span> means it’s a standard character you can get with Pure Cores.
...
<div class="awakener-index-group">
  <ul class="awakener-index-grid grid-96">
    ...
    <li>
      <a href="/handbook/awakeners/caecus/" class="tierlist-standard-unit">
        <img src="/images/awakeners/aequor/caecus--mini.png" loading="lazy">
        <div class="tierlist-label">
          <div class="name">Caecus</div>
        </div>
      </a>
    </li>
    <li>
      <a href="/handbook/awakeners/faros/" class="tierlist-standard-unit">
        <img src="/images/awakeners/aequor/faros--mini.png" loading="lazy">
        <div class="tierlist-label">
          <div class="name">Faros</div>
          <div class="enlighten">E2</div>
        </div>
      </a>
    </li>
    <li>
      <a href="/handbook/awakeners/agrippa/" class="tierlist-standard-unit">
        <img src="/images/awakeners/caro/agrippa--mini.png" loading="lazy">
        <div class="tierlist-label">
          <div class="name">Agrippa</div>
          <div class="enlighten">E3</div>
        </div>
      </a>
    </li>
...
<div class="awakener-index-group">
  <ul class="awakener-index-grid grid-96">
    ...
    <li>
      <a href="/handbook/awakeners/pandia/" class="tierlist-standard-unit">
        <img src="/images/awakeners/chaos/pandia--mini.png" loading="lazy">
        <div class="tierlist-label">
          <div class="name">Pandia</div>
        </div>
      </a>
    </li>
    <li>
    ...
    <li>
      <a href="/handbook/awakeners/sanga/" class="tierlist-standard-unit">
        <img src="/images/awakeners/aequor/sanga--mini.png" loading="lazy">
        <div class="tierlist-label">
          <div class="name">Sanga</div>
        </div>
      </a>
    </li>
    <li>
    ...
    <li>
      <a href="/handbook/awakeners/wanda/">
        <img src="/images/awakeners/ultra/wanda--mini.png" loading="lazy">
        <div class="tierlist-label">
...
<div class="awakener-index-group">
  <ul class="awakener-index-grid grid-96">
    ...
    <li>
      <a href="/handbook/awakeners/erica/" class="tierlist-free-unit">
        <img src="/images/awakeners/ultra/erica--mini.png" loading="lazy">
        <div class="tierlist-label">
    ...
    <li>
      <a href="/handbook/awakeners/tinct/" class="tierlist-standard-unit">
        <img src="/images/awakeners/ultra/tinct--mini.png" loading="lazy">
        <div class="tierlist-label">
          <div class="name">Tinct</div>
        </div>
      </a>
    </li>
    <li>
      <a href="/handbook/awakeners/winkle/" class="tierlist-standard-unit">
        <img src="/images/awakeners/ultra/winkle--mini.png" loading="lazy">
        <div class="tierlist-label">
          <div class="name">Winkle</div>
        </div>
      </a>
    </li>
    <li>
