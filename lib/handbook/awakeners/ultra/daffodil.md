...
Daffodil is a burst DPS who slaps enemies with high-damage command cards. While she can be tricky to use, she’s capable of powerful combos in the right team.

In addition to damage, Daffodil can inflict vulnerable, boost teamwide Crit Rate, and access many supportive effects with Thousand Mirage. She is the only character in the game that can speed up your Ultra Round.
...
The **0-cost Mirage** is Daffodil’s best source of sustained damage, useful for grinding down bosses in long fights. It doesn’t cost any arithmetica, making it easier to fit into awkward turns. If you’re running Daffodil as a support, this Mirage is the cheapest way to get the orison you want.

The **2-cost Mirage** is the strongest source of temporary counter in the game. It can do a lot of damage to enemies with multihit intentions. If you have a character that converts counter into damage like [Pandia](/handbook/awakeners/pandia/) or [OE Nautila](/handbook/awakeners/nautila/), this Mirage gives them a lot of ammunition.

The **4-cost Mirage** has the highest Base DMG, which makes it good for securing kills and getting last hits on mobs. The bonus effects are also quite potent, and can do things like nullify enemy STR or make you immune to incoming debuffs.
