---
title: Liz
description: Builds, strategy, and gameplay tips for the Morimens character Liz.
template: awakeners/awakener.html
awakener:
  tagline: High-Maintenance Poison DPS
  roles:
    - Poison
    - Multihit
    - Discard
    ...
    - name: Example Build (DPS)
      ...
      wheels:
        ...
        astral_reign:
          ...
          - id: critical-point
  suggested_posses:
    - id: black-swans-dance
      note: 'Psyche Deepdive: Liz'
  works_well_with:
    - xu
    - clementine
    - lily
